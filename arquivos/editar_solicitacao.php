...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE solicitacoes 
            ...
            WHERE IDsolicitacao = ? AND IDcliente = ?";
    $stmt = mysqli_prepare($id, $sql);

    mysqli_stmt_bind_param($stmt, "ssii", $titulo, $descricao, $idSolicitacao, $idCliente);
...
$solicitacao = mysqli_fetch_assoc($res);
...
<body>
    <header>
        <img src="../servigeralateral.png" alt="ServiGera" style="height:80px; width:auto; border-radius:10px;">
        <nav>
    ...
    <main>
        <div class="container">
            ...
            <form method="post">
                ...
                <input type="text" id="titulo" name="titulo" required value="<?php echo htmlspecialchars($solicitacao['titulo']); ?>">

                <label for="descricao">Descrição *</label>
                <textarea id="descricao" name="descricao" rows="5" required><?php echo htmlspecialchars($solicitacao['descricao']); ?></textarea>

                <div class="botoes">
                    <button type="submit" class="btn">Atualizar Solicitação</button>
